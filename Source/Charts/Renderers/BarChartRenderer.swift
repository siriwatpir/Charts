...
open class BarChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    private func drawGradientBars(
        ...
        for i in 0..<buffer.count{
            ...
            for position in gradientPositions[i].reversed()
            {
            ...
            for color in (dataSet as! BarChartDataSet).gradientColors![i].reversed()
            {
                ...
                {
                    gradientColorComponents += [component[0], component[1], component[2]  , component[3]]
                }
            }
